...
const StatusMenu = ({ row, column, table }) => {
  ...
  return (
    <div
      className={`cursor-pointer relative w-fit grid justify-center py-1 font-sans text-xs font-bold uppercase rounded-md select-none whitespace-nowrap ${currentStyle} ${
